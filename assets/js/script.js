...
var taskFormHandler = function(event) {
    ...
    //has data attributes, so get id and call function to complete edit process
    if (isEdit) {
...
var createTaskActions = function(taskId) {
    ...
    //array of elements that go in the dropdown
...
var editTask = function(taskId) {
    ...
    var taskName = taskSelected.querySelector("h3.task-info").textContent;
...
var completeEditTask = function(taskNameInput, taskTypeInput, taskId) {
    ...
    var taskSelected = document.querySelector(".task-item[data-task-id='" + taskId + "']");
    //set new values
    taskSelected.querySelector("h3.task-info").textContent = taskNameInput;
